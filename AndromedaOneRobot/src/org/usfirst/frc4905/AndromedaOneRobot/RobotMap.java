...
public class RobotMap
{
	...
	LiveWindow.addActuator("myDriveTrain", "RightMotor_Controller", (Victor) myDriveTrainRightMotor_Controller);
        
        myDriveTrainLeftMotor_Controller = new Victor(1, 5);
	LiveWindow.addActuator("myDriveTrain", "LeftMotor_Controller", (Victor) myDriveTrainLeftMotor_Controller);
        
        myDriveTrainmyRobotDrive = new RobotDrive(myDriveTrainLeftMotor_Controller, myDriveTrainRightMotor_Controller);
	...
	LiveWindow.addActuator("ArmPlatform", "PlatformMotor_Controller", (Jaguar) armPlatformPlatformMotor_Controller);
        
        armPlatformPlatformPot = new AnalogChannel(1, 1);
	LiveWindow.addSensor("ArmPlatform", "PlatformPot", armPlatformPlatformPot);
        
        robotArmsArmsMotor_Controller = new Jaguar(1, 4);
	LiveWindow.addActuator("RobotArms", "ArmsMotor_Controller", (Jaguar) robotArmsArmsMotor_Controller);
